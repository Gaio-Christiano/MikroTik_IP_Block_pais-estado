...
with open(file_path, "r") as arquivo:
    for linha in arquivo:
        ...
        if match:
            ip = match.group(1)
            data = match.group(2) if match.group(2) else "Data Ausente"
            hora = match.group(3) if match.group(3) else "Hora Ausente"
...
arquivo_saida = f"02_Relatorio_Completo_{hora_atual}.xlsx"
